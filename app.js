...
(function () {
  ...
  var FLAVORS = [
    { id: 'casa', name: 'De la Casa', desc: 'Nuestra receta original, el sabor que nos hizo famosos.', gradient: 'linear-gradient(135deg, #E84B8A 0%, #F06292 100%)', badge: 'Original', badgeColor: '#E84B8A', image: 'images/reviewer-elfresa.jpg' },
    { id: 'casa-pic', name: 'De la Casa Picante', desc: 'La receta original con un toque de picante irresistible.', gradient: 'linear-gradient(135deg, #F57C00 0%, #FFB74D 100%)', badge: 'Picante', badgeColor: '#F57C00', image: 'images/michelada-love.jpg' },
    { id: 'ranchero', name: 'Sabor Ranchero', desc: 'Un sabor casero y con personalidad propia.', gradient: 'linear-gradient(135deg, #8D6E63 0%, #D7CCC8 100%)', badge: 'Popular', badgeColor: '#8D6E63', image: 'images/product-delivery.jpg' },
    { id: 'ranchero-pic', name: 'Sabor Ranchero Picante', desc: 'El ranchero con un kick de picante extra.', gradient: 'linear-gradient(135deg, #AD1457 0%, #E91E63 100%)', badge: 'Intenso', badgeColor: '#AD1457', image: 'images/michelada-valentino.jpg' },
  ];

  // Picona Mix
  var PICONAS = [
    { id: 'picona', name: 'Picona Mix', desc: 'Nuestra mezcla especial para los valientes.', gradient: 'linear-gradient(135deg, #C62828 0%, #EF5350 100%)', badge: 'Fuerte', badgeColor: '#C62828', image: 'images/picona-mix.jpg' },
    { id: 'picona-pic', name: 'Picona Mix Picante', desc: 'Para los que no le tienen miedo al picante.', gradient: 'linear-gradient(135deg, #BF360C 0%, #FF7043 100%)', badge: 'Extra Fuerte', badgeColor: '#BF360C', image: 'images/delivery-service.jpg' },
  ];
  ...
  function buildProductCard(item, prefix, sizes) {
    ...
    var imgContent = item.image
      ? '<img src="' + item.image + '" alt="' + item.name + ' — GUD Monchis" class="product-photo" loading="lazy">' +
        '<div class="product-img-overlay" style="background:' + item.gradient + '"></div>'
      ...
      '<div class="hero-content">' +
        '<div class="hero-split">' +
          ...
          '<div class="hero-image">' +
            '<img src="images/michelada-valentino.jpg" alt="Michelada artesanal GUD Monchis" loading="eager">' +
          '</div>' +
        '</div>' +
      '</div>';
    return section;
      ...
      '<div class="section-pad">' +
        ...
        '<div class="evento-wrapper">' +
          '<div class="evento-info">' +
            '<div class="evento-hero-img">' +
              '<img src="images/michelada-fancy.jpg" alt="Micheladas artesanales en evento privado" loading="lazy">' +
            '</div>' +
    ...
    section.innerHTML =
      '<div class="section-pad">' +
        '<div class="about-grid">' +
          '<div class="about-img">' +
            '<img src="images/bartender-friends.jpg" alt="Fundadora de GUD Monchis preparando bebidas artesanales" loading="lazy">' +
          '</div>' +
  ...
  // ==================
  var INSTA_IMAGES = [
    { src: 'images/michelada-valentino.jpg', alt: 'Preparando michelada artesanal con chamoy' },
    { src: 'images/michelada-fancy.jpg', alt: 'Micheladas en evento privado al aire libre' },
    { src: 'images/reviewer-elfresa.jpg', alt: 'Disfrutando una michelada con limón' },
    { src: 'images/picona-mix.jpg', alt: 'Botella de Picona Mix GUD Monchis' },
    { src: 'images/michelada-love.jpg', alt: 'Michelada lista para tomar' },
    { src: 'images/bartender-friends.jpg', alt: 'La creadora de las bebidas más ricas' },
    { src: 'images/product-delivery.jpg', alt: 'Servicio a domicilio GUD Monchis' },
    { src: 'images/delivery-service.jpg', alt: 'Mix de michelada para llevar' },
    { src: 'images/event-store.jpg', alt: 'GUD Monchis en eventos y tiendas' },
    { src: 'images/michelada-store.jpg', alt: 'Punto de venta GUD Monchis zona 16' },
  ];

  function buildInstagramGallery() {
    var section = document.createElement('section');
    section.className = 'instagram-section';
    section.id = 'instagram';

    var galleryItems = INSTA_IMAGES.map(function (img) {
      return (
        '<a href="https://www.instagram.com/gudmonchisgt/" target="_blank" rel="noopener" class="insta-item">' +
    ...
    section.innerHTML =
      '<div class="section-pad">' +
        '<div class="section-header">' +
          ...
          '<h2>@gudmonchisgt</h2>' +
          '<p>Mir\u00E1 lo que nuestros clientes disfrutan. S\u00EDguenos en Instagram para m\u00E1s contenido.</p>' +
        '</div>' +
        '<div class="insta-grid">' + galleryItems + '</div>' +
        '<div class="insta-cta">' +
          '<a href="https://www.instagram.com/gudmonchisgt/" target="_blank" rel="noopener" class="btn-instagram">' +
      ...
      '<div class="footer-grid">' +
        ...
        '<div class="footer-col">' +
          ...
          '<ul>' +
            ...
            '<li><svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16" style="width:16px;height:16px;display:inline-block;vertical-align:middle;margin-right:6px"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg> <a href="https://www.instagram.com/gudmonchisgt/" target="_blank" rel="noopener">@gudmonchisgt</a></li>' +
          '</ul>' +
        '</div>' +
      '</div>' +
  ...
  function init() {
    ...
    app.appendChild(buildInstagramGallery());
